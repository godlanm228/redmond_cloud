...
def main() -> None:
    ...
    # Расписание переехало из кода в данные 21.08.2026 — переносим один раз.
    # Пока оно было константой, его нельзя было отменить: запись «у меня
    # каникулы» ложилась в дневник, а бот продолжал звать на пары.
    from logic.week_schedule import seed_timetable_if_empty  # noqa: E402
