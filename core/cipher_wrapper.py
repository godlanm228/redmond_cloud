...
CLAUDE.md описывал деплой через ssh с виндовым путём к ключу, и Cipher,
...
- Логи бота: ~/redmond-hub/logs/v2.log (сервис redmond-hub.service под systemd).
  Инструкции в CLAUDE.md про nohup и /tmp/v2.log устарели, не следуй им.
- База: ~/redmond-hub/data/memory.sqlite (SQLite). data/coach/*.json — замороженный
  архив до миграции 15.08.2026, живыми данными НЕ является.
