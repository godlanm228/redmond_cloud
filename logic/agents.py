...
IRIS = AgentConfig(
    ...
    description=(
        ...
        "здоровье, ЕДА/питание/рацион (что поел, что приготовить, запас продуктов), "
        "спорт/тренировки, финансы, дисциплина. Жёсткая, конкретная, без воды. Не утешает — гонит вперёд. "
